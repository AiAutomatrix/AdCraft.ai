...
import { Loader2, Wand2, Upload, X, Camera, Car } from 'lucide-react';
    ...
    <div className="container py-12">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>Upload pictures of your vehicle, or use your camera to take one. Images will be saved when you finalize the ad.</CardDescription>
        </CardHeader>
              ...
              <div className="w-full h-64 border-2 border-dashed border-border rounded-lg flex flex-col items-center justify-center text-muted-foreground bg-muted/20">
                {isProcessingImage ? (
                    ...
                    <>
                        ...
                        <p className="font-semibold mb-2">Add photos of your vehicle</p>
