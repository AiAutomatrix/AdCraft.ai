    ...
    <div className="container py-12">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>Describe what you're looking for. You can also upload or take reference photos. Images will be saved when you finalize the ad.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
              ...
              {imagePreviews.length > 0 ? (
                ...
                <div className="w-full h-48 border-2 border-dashed border-border rounded-lg flex flex-col items-center justify-center text-muted-foreground bg-muted/20">
                  {isProcessingImage ? (
                      <>
