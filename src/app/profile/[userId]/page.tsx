...
import { Car, Loader2, Search, Briefcase, Package, ChevronsUpDown, Share2 } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 md:mb-12 gap-4">
        {userProfile && (
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="font-headline text-3xl font-bold tracking-tight sm:text-4xl text-left">{userProfile.displayName}'s Ads</h1>
                    <p className="mt-1 text-text-secondary text-left">Browse all the ads posted by this user.</p>
                </div>
            </div>
        )}
